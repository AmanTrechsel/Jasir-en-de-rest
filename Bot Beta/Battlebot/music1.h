...
int musicNotes = sizeof(melody) / sizeof(melody[0]) / 2;
...
void startMusic() {
  ...
  for (int thisNote = 0; thisNote < musicNotes * 2; thisNote = thisNote + 2) {
    ...
    tone(musicBuzzer, melody[thisNote], noteDuration*0.9);
